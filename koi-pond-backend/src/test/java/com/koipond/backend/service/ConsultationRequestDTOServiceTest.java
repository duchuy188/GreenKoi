...
class ConsultationRequestDTOServiceTest {
    ...
    void getConsultationRequests_ForCustomer() {
        ...
        // Act
        List<ConsultationRequestDTO> result = consultationRequestService.getConsultationRequests(username);
    ...
    void updateStatus_SuccessfulUpdate() {
        ...
        // Act
        ConsultationRequestDTO result = consultationRequestService.updateStatus(requestId, newStatus, username);
