      ...
      <div className="footer-content">
        ...
        <div className="footer-section">
          ...
          <ul>
            ...
            <button><Link to="/lapthietketheoyeucau">Gửi yêu cầu thiết kế</Link></button>
            <li>
            <h6>Chứng chỉ Năng lực Hoạt động Xây dựng Cấp III. Số: HCM-99999, cấp ngày 19/10/2024 tại Sở Kế hoạch và Đầu tư thành phố Hồ Chí Minh.</h6>
            </li>
          </ul>
        </div>
        ...
        <div className="footer-section">
          ...
          <div className="card">
            ...
            <a className="socialContainer containerThree" href="https://mail.google.com" target="_blank">
            ...
            <a className="socialContainer containerFour" href="https://www.pinterest.com" target="_blank">
